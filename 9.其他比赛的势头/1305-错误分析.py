...
def Momentum(path):
    ...
    sns.lineplot(x=df['elapsed_time'].values, y=Mg_1, label='Momentum of Player 1', errorbar=None)
    sns.lineplot(x=df['elapsed_time'].values, y=Mg_2, label='Momentum of Player 2', color='#D54A3B', errorbar=None)
    ...
    sns.scatterplot(x=p1_tps_time, y=p1_tps_Mg_1, color='#E6756E', marker='o', label='Three Points Player 1')
    sns.scatterplot(x=p2_tps_time, y=p2_tps_Mg_1, color='#579AC3', marker='o', label='Three Points Player 2')
    ...
    plt.ylabel("Momentum")
    plt.title(f"Momentum of Player 1 and Player 2 by Time  [Match_id: {path[0:4]}] ")
