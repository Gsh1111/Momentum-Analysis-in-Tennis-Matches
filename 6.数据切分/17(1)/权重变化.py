...
# 读取Excel表格
df = pd.read_excel('1305.xlsx')  # 替换为你的Excel文件路径
...
# sns.lineplot(x='elapsed_time', y='S1_sum', label='Performance_p1', data=df)
# sns.lineplot(x='elapsed_time', y='S2_sum', color='#D54A3B', label='Performance_p2', data=df)
#
...
#
# # 设置图表标题和标签
# plt.title('Performance of p1 and p2 [1305]',fontsize= 14)
